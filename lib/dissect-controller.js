(function()
{
	...
	DissectController.prototype =
	{
		...
		getAll : function()
		{
			...
			buf += "		else\n";
			buf += "			res.render('" + this.name + "/get-all', { " + this.name + "s : " + this.name + "s });\n";
			buf += "	});\n";
			buf += "};\n\n";
		...
		getSingle : function()
		{
			...
			buf += "		else\n";
			buf += "			res.render('" + this.name + "/get-single', { " + this.name + " : " + this.name + " });\n";
			buf += "	});\n";
			buf += "};\n\n";
		...
		createForm : function()
		{
			...
			buf += "{\n";
			buf += "	res.render('" + this.name + "/create');\n";
			buf += "};\n\n";
		...
		updateForm : function()
		{
			...
			buf += "{\n";
			buf += "	res.render('" + this.name + "/update');\n";
			buf += "};\n\n";
		...
		delete : function()
		{
			...
			buf += "		else\n";
			buf += "			res.render('" + this.name + "/delete');\n";
			buf += "	});\n";
			buf += "};\n\n";
