(function()
{
	...
	DissectServer.prototype =
	{
		...
		bufferForExpress : function(models)
		{
			...
			buf += "  , methodOverride = require('method-override')\n"
			...
			buf += "	app.use(express.urlencoded());\n";
			buf += "	app.use(express.json());\n";
			buf += "	app.use(methodOverride('_method'));\n";
			buf += "});\n\n";
